...
export default function Page() {
  return (
    <div>
    <main className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-b from-transparent via-green-900 via-55% to-transparent px-4">
